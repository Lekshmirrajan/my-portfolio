...
{/* TECHNICAL SKILLS */}
<section id="technical-skills" data-aos="fade-up" className="mt-16 bg-white/50 backdrop-blur-xl p-8 rounded-3xl border border-white/30 shadow-sm hover:shadow-md transition-all duration-300">
  <h3 className="text-3xl font-semibold mb-4">Technical Skills</h3>

  <div className="grid md:grid-cols-2 gap-8 mt-6">

    {/* Programming */}
    <div className="p-5 bg-white rounded-xl shadow border border-gray-100 hover:shadow-md transition-all">
      <h4 className="font-semibold text-lg mb-3 text-purple-700">Programming Languages</h4>
    ...
    {/* Frontend */}
    <div className="p-5 bg-white rounded-xl shadow border border-gray-100 hover:shadow-md transition-all">
      <h4 className="font-semibold text-lg mb-3 text-purple-700">Frontend Development</h4>
      <ul className="text-sm text-slate-700 space-y-2">
        <li>• React.js</li>
        <li>• HTML5, CSS3</li>
        <li>• Tailwind CSS</li>
        <li>• Responsive UI, AOS Animations</li>
      </ul>
    </div>

    {/* Backend */}
    <div className="p-5 bg-white rounded-xl shadow border border-gray-100 hover:shadow-md transition-all">
      <h4 className="font-semibold text-lg mb-3 text-purple-700">Backend Development</h4>
      <ul className="text-sm text-slate-700 space-y-2">
    ...
    {/* Tools & Other */}
    <div className="p-5 bg-white rounded-xl shadow border border-gray-100 hover:shadow-md transition-all">
      <h4 className="font-semibold text-lg mb-3 text-purple-700">Tools & Other Skills</h4>
      <ul className="text-sm text-slate-700 space-y-2">
        <li>• Git & GitHub</li>
        <li>• VS Code</li>
        <li>• Postman</li>
        <li>• Figma (Basic UI Design)</li>
        <li>• Canva & Presentation Tools</li>
      </ul>
    </div>
